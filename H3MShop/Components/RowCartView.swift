                ...
                VStack(alignment: .leading){
                    ...
                    HStack{
                        Button {
                            ...
                            Task{
                                do{
                                    ...
                                    if self.quantity > 1 {
                                        self.quantity -= 1
                                        try await authViewModel.editCart(id_product: id_product, number: quantity)
                                    }
                                    else{
                                        try await
                                        authViewModel.deleteRowCart(id_product: id_product)
                                    }
                                }
                                catch{
                        ...
                        Button {
                            ...
                            Task{
                                do{
                                    try await authViewModel.deleteRowCart(id_product: id_product)
                                }
                                catch{
